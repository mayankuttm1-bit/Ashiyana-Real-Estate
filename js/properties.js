...
function createPropertyCardHTML(prop) {
    ...
    return `
    <div class="property-card" data-category="${prop.type}" data-location="${prop.areaZone}" data-id="${prop.id}">
        ...
        <div class="property-content">
            ...
            <div class="property-actions">
                ...
                <a href="${waLink}" target="_blank" rel="noopener noreferrer" class="btn-card-inquire">
